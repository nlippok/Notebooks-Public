...
* The link below initiates a self-running simulation based on Jupyter Notebook (Python3). No installation of Jupyter Notebook or Python nor prior knowledge is required.
* Starting the server (based on <a href="https://mybinder.org" target="_blank">MyBinder</a>) for the first time could take up to 10 minutes. Please be patient. Unfortunately, sometimes the <a href="https://mybinder.org" target="_blank">MyBinder</a> server is too busy. Please try another time in this case.
