...
* Alternatively, the Notebook (`notebook.ipynb`) can be downloaded and run within a Jupyter environment. To download the entire repository, go to the previous directory (<a href="https://github.com/nlippok/Notebooks-Public" target="_blank" <Notebooks-Public</a>) and download the CR-OCT-RF folder by clicking the Code botton (Download ZIP). Note that all the files above (`*.ipynb`, `setup.png`) are required to run the simulation. Running the Notebook externally requires the installation of Jupyter Notebook and Python. We recommend downloading the <a href="https://www.anaconda.com/products/individual" target="_blank">Anaconda</a> package, which is free. 
