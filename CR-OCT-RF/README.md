...
* The two links below initiate a simulation based on Jupyter Notebook (Python). Neither knowledge nor installation of Python / Jupyter is required. Starting the server (based on <a href="https://mybinder.org" target="_blank">MyBinder</a>) for the first time can take up to 10 minutes. Please be patient. Sometimes the <a href="https://mybinder.org" target="_blank">MyBinder</a> server can be too busy. Please try another time in this case.
